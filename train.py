...
def train(
    ...
    if resume:  # Load previously saved model
        if transfer:  # Transfer learning
            ...
            model.load_state_dict({k: v for k, v in chkpt['model'].items() if v.numel() > 1 and v.shape[0] != 18},
                                  strict=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dist-url', default='tcp://127.0.0.1:8881', type=str, help='distributed training init method')
